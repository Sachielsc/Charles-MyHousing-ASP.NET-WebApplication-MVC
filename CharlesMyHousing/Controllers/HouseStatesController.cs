...
namespace CharlesMyHousing.Controllers
{
    public class HouseStatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "HouseStateId,HouseType,Postcode,RentRate,MainAddress,Suburb,Region,Description,Bedroom,Bathroom,CarparkOk,PetOk,OnMarktetFlg,Latitude,Longitude")] HouseState houseState)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "HouseStateId,HouseType,Postcode,RentRate,MainAddress,Suburb,Region,Description,Bedroom,Bathroom,CarparkOk,PetOk,OnMarktetFlg,Latitude,Longitude")] HouseState houseState)
        {
            if (ModelState.IsValid)
            {
